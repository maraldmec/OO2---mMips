...
void trace_mips( sc_trace_file *tf, mMIPS *mips, const char *prefix )
{
  ...
  _do_trace(tf, mips->bus_pipe_en_and, "bus_pipe_en_and");
  _do_trace(tf, mips->bus_ito_div, "bus_ito_div");
  _do_trace(tf, mips->bus_ito_div, "bus_iti_div");
  _do_trace(tf, mips->bus_d_div, "bus_d_div");
  ...
  _do_trace(tf, mips->bus_reg_mux2, "bus_reg_mux2");
  _do_trace(tf, mips->bus_hazard_div, "bus_hazard_div");
  ...
  _do_trace(tf, mips->bus_imm2word, "bus_imm2word");
   _do_trace(tf, mips->  bus_reg_aluctrl, "bus_reg_aluctrl");
